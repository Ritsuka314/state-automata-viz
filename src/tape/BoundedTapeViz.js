'use strict';
var Tape = require('./BoundedTape.js'),
    d3   = require('d3');
require('./tape.css');
...
function BoundedTapeViz(svg, lookaround, input) {
  Tape.call(this, input);
...
BoundedTapeViz.prototype = Object.create(Tape.prototype);
BoundedTapeViz.prototype.constructor = BoundedTapeViz;

// IDEA: chain headLeft/Right to wait for write()?
BoundedTapeViz.prototype.write = function (symbol) {
...
BoundedTapeViz.prototype.headRight = function () {
...
BoundedTapeViz.prototype.headLeft = function () {
